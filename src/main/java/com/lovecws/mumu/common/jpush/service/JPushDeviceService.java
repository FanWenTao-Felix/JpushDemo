...
import com.lovecws.mumu.common.jpush.exception.JPushDeviceException;
...
public class JPushDeviceService {
	 ...
	 * 对标签进行添加用户或者删除用户
	 * @param theTag标签
	 * @param toAddUsers 添加用户集合
	 * @param toRemoveUsers 删除用户集合
	 * @return
	 * @throws JPushDeviceException
	 */
